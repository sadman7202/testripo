...
public class books {
    ...
    public  int count;
    {
        theBooks[0]=new book(1,"Himur Rupali Ratri","Humayun Ahmed",10);
        theBooks[1]=new book(2,"TandraBilash","Humayun Ahmed",10);
        theBooks[2]=new book(3,"Gitanjali","Rabindranath Tagore",10);
        count=3;
    }
